...
describe User do
	...
	describe "when email format is invalid" do
		it "should be invalid" do
			addresses = %w[user@foo,com user_at_foo.org exapmle.user@foo. foo@bar_baz.com foo@bar+baz.com foo@bar..com]
	...
	describe "micropost associations" do
		...
		it "should hvae the right micropost in the right order" do
